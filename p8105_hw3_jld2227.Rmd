...
Clearly, from the table, none were observed at exactly 7 locations. None had observations at exactly 7 locations in any year.
...
brfss %>% 
  ...
  ex_mean_prop = mean(data_value/100,na.rm = T))
  ggplot() + geom_point()
```
