...
Clearly, from the table, the following: `r print(n_7)` were observed at exactly 7 locations. `r print(n_7)` had observations at exactly 7 locations in any year.
...
tmaxmin_hex + snow_year_dist + plot_layout(ncol=2,widths=c(1,2))
```
